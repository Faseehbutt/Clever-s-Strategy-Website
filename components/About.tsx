  ...
  return (
    <section id="about" className="relative py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <motion.h2
          className="text-5xl md:text-6xl font-bold text-center mb-12 neon-teal"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-3xl font-bold text-neon-gold mb-4">Clever Community</h3>
          ...
          >
            {[...Array(4)].map((_, i) => (
              <motion.div
                key={i}
                className="w-32 h-32 glass rounded-full flex items-center justify-center border-2 border-neon-teal/30 hover:border-neon-gold hover:glow-gold transition-all cursor-pointer"
